...
public class TestHotSwap {  
    ...
    public static void main(String args[]) throws MalformedURLException {  
        ...
        try {  
            URL[] urls = new URL[]{ new URL("file:///Users/zhoushengqiang/Documents/code/climber/Climber/SpringCloudParent/cloud_basecore/target/classes/") };
            HotSwapClassLoader c1 = new HotSwapClassLoader(urls, a.getClass().getClassLoader());

            Class clazz = c1.load("com.climber.cloud_basecore.jvm.classloader.A");  // 用hot swap重新加载类A
            ...
            B bInstance = (B)method2.invoke(aInstance);  // 调用getB()方法
            System.out.println(bInstance.getAge());
